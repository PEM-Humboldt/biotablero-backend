# Biotablero Species Diversity service
...
**NOTE**: _If you change the server port in the configuration (4003 by default), you'll need to change the exposed port in the Dockerfile and rebuild the image_
